package webAuction.auction.service;
...
public class DefaultSellerServiceTest {
    ...
    public void testOfferItem() {
        ...
        User user1 = defaultRegistrationService.registerUser("xx@webAuction.nl");
    ...
    public void testRevokeItem() {
        ...
        User seller = defaultRegistrationService.registerUser("sel@webAuction.nl");
        User buyer = defaultRegistrationService.registerUser("buy@webAuction.nl");
        Category cat = new Category("cat1");
