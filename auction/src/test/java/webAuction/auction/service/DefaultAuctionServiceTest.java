...
public class DefaultAuctionServiceTest {
    ...
    @Test
    public void getItem() {
        String email = "xx2@webAuction.nl";
        String omsch = "omsch";
    ...
    public void findItemByDescription() {
        String email3 = "xx3@webAuction.nl";
        String omsch = "omsch";
        String email4 = "xx4@webAuction.nl";
    ...
    public void newBid() {
        ...
        String email = "ss2@webAuction.nl";
        String emailb = "bb@webAuction.nl";
        String emailb2 = "bb2@webAuction.nl";
